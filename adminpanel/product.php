     ...
     <div class="main-container">
         ...
         <div class="main-wrapper">
             ...
             <div class="main-title-wrapper">
                 ...
                 <h3 class="main-hd">Products Design</h3>
             </div>
 ...
 <?php
    if (isset($_POST['add'])) {
        ...
        alert('Please fill all the fields!');
            ...
            move_uploaded_file($temp_name1, "db_images/products/$img");


            $add = "insert into products (title, description, img, date) 
