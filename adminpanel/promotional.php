     ...
     <div class="main-container">
         ...
         <div class="main-wrapper">
             ...
             <div class="main-title-wrapper">
                 ...
                 <h3 class="main-hd">Promotional Stuff</h3>
             </div>

             <div class="add-product-wrapper">
                 <form action="promotional.php" method="POST" enctype="multipart/form-data">
 ...
 <?php
    if (isset($_POST['add'])) {
        ...
        alert('Please fill all the fields!');
            ...
            move_uploaded_file($temp_name1, "db_images/promotions/$img");


            $add = "insert into promotional (title, description, img, date) 
