  ...
  <body>
    ...
    <div class="main-container animated animatedFadeInUp fadeInUp">
      ...
      <div class="works">
        ...
        <?php
                    $get_works = "select * from promotional order by rand() LIMIT 0,50";
                    ...
                    while ($row_works = mysqli_fetch_array($run_works)) {
                        ...
                        echo "
                        <div class= 'work'>
          <img src='../adminpanel/db_images/promotions/$img' >
        ...
        <img src="../adminpanel/db_images/promotions/" alt="">
